...
#define MAX_APPLICATION_SPEED_RPM           4998 /*!< rpm, mechanical */
#define MIN_APPLICATION_SPEED_RPM           0 /*!< rpm, mechanical, absolute value */
#define M1_SS_MEAS_ERRORS_BEFORE_FAULTS     100 /*!< Number of speed measurement errors before main sensor goes in fault */
...
#define PID_TORQUE_KP_DEFAULT               2339
#define PID_TORQUE_KI_DEFAULT               2365
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2339
#define PID_FLUX_KI_DEFAULT                 2365
...
#define PID_SPEED_KP_DEFAULT                3051/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                24/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define IQMAX_A                             14.175

/* Default settings */
#define DEFAULT_CONTROL_MODE                MCM_SPEED_MODE
#define DEFAULT_TARGET_SPEED_RPM            1799
#define DEFAULT_TARGET_SPEED_UNIT           (DEFAULT_TARGET_SPEED_RPM*SPEED_UNIT/U_RPM)
#define DEFAULT_TORQUE_COMPONENT_A          0
#define DEFAULT_FLUX_COMPONENT_A            0

/**************************    FIRMWARE PROTECTIONS SECTION   *****************/
#define OV_VOLTAGE_THRESHOLD_V              28.1 /*!< Over-voltage threshold */
...
#define PHASE1_FINAL_CURRENT_A              14.175

/* Phase 2 */
#define PHASE2_DURATION                     3998 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (1999*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              14.175

/* Phase 3 */
#define PHASE3_DURATION                     0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (1999*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              14.175

/* Phase 4 */
#define PHASE4_DURATION                     0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (1999*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              14.175

/* Phase 5 */
#define PHASE5_DURATION                     0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (1999*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT_A              14.175
...
#define OBS_MINIMUM_SPEED_RPM               1799
