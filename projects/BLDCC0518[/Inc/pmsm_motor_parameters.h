...
#define LS                      0.00028 /* Stator inductance, H
...
#define MOTOR_MAX_SPEED_RPM     4998 /*!< Maximum rated speed  */
#define NOMINAL_CURRENT_A       14.175

#define ID_DEMAG_A              -14.175 /*!< Demagnetization current */
