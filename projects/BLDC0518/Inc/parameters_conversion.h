...
#define RESISTOR_OFFSET                     0.02 /* computed resitance offset to compensate error meaasuremnt due to board */
...
#define DC_CURRENT_RS_MEAS                  ((7) * 80) / 100 /* Maximum level of direct current = 80% of Max Board current */
...
#define SAMPLING_CYCLE_CORRECTION           0.5 /* Add half cycle required by STM32L476RGTx ADC */
